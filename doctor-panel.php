...
if(isset($_GET['cancel']))
  {
    ...
    if($query)
    {
      echo "<script>alert('Seu compromisso foi cancelado com sucesso');</script>";
    }
  }
...
<html lang="pt-BR">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> SimplificaMED </a>
                  ...
                  <?php 
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        <button class="btn btn-success">Prescrever</button></a>
                        <?php } else {
