 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Encontro</a>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <select name="payment" class="form-control" >
                      ...
                      <option value="Pague mais tarde">Pague mais tarde</option>
                    </select>
                  </div><br><br><br>
                  <div class="col-md-4">
        ...
        <div class="card">
          <div class="card-body">
            <form class="form-group" method="post" action="func.php">
              <input type="text" name="contact" class="form-control" placeholder="Digite seu Contato"><br>
